...
<li> <b>Font intelligence</b>: PDF parsing, PDF to JSON, and detection of contextual elements based on font type, relative size and color.
  ...
  <li><b>Multimodal processing</b>b> to retrieve images, videos, tables and so on, for instance as input to the predictive analytics or data synthesis agents</li>
  ...
  <li><b>Fine-tuning</b>b> in real time with intuitive hyperparameter sets, each component having its own set</li>
</ul>
