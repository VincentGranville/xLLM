...
<ul>
<li> Font intelligence: PDF parsing, PDF to JSON, and detection of contextual elements based on font type, relative size and color.
  <li>Sorterd <i>n</i>-grams that takes the order of the multitokens in a sentence (the attention mechanism)</li>
</ul>
